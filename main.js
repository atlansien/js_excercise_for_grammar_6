...
// {}内に囲まれている領域をブロックと呼び、ブロック内でlet,constを使い宣言された変数はブロック外からアクセスすることができない
// 逆に、ブロック内からブロック外からアクセスすることはできる

// 課題2: 「コメント」を使って変数の関数スコープの説明をしてください
//   - コメントとは: https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Lexical_grammar#%E3%82%B3%E3%83%A1%E3%83%B3%E3%83%88

// ここに「関数スコープ」の説明を記述する
//　varで宣言された変数の場合は、{}の中にあってもブロック外からアクセスすることができる。
// ただし、関数の引数や、関数内で宣言された変数はブロック外からアクセスすることができない。
...
const discriminantNumber = message => {
  alert(message);
};
